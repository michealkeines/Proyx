use crate::protocols::h2::codec::{SendError, UserError};
use crate::protocols::h2::frame::StreamId;
use crate::protocols::h2::proto::{self, Initiator};

use bytes::Bytes;
use std::{error, fmt, io};

pub use crate::protocols::h2::frame::Reason;
...
impl From<proto::Error> for Error {
    fn from(src: proto::Error) -> Error {
        use crate::protocols::h2::proto::Error::*;
