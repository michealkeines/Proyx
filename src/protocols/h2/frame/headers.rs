...
use crate::protocols::h2::frame::{Error, Frame, Head, Kind};
use crate::protocols::h2::hpack::{self, BytesStr};
...
impl Iterator for Iter {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        use crate::protocols::h2::hpack::Header::*;
...
mod test {
    ...
    use crate::protocols::h2::hpack::{Encoder, huffman};
