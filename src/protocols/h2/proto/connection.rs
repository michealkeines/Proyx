...
use crate::protocols::h2::frame::{Reason, StreamId};
use crate::protocols::h2::{client, server};

use crate::protocols::h2::frame::DEFAULT_INITIAL_WINDOW_SIZE;
use crate::protocols::h2::proto::*;
    ...
    B: Buf,
{
        ...
        match result {
            ...
            Err(Error::Reset(id, reason, initiator)) => {
                ...
                match self.streams.send_reset(id, reason) {
                    Ok(()) => (),
                    Err(crate::protocols::h2::proto::error::GoAway { debug_data, reason }) => {
    ...
    fn recv_frame(&mut self, frame: Option<Frame>) -> Result<ReceivedFrame, Error> {
        use crate::protocols::h2::frame::Frame::*;
        match frame {
            Some(Headers(frame)) => {
