use crate::protocols::h2::error::Reason;
use crate::protocols::h2::frame::{Pseudo, StreamId};
use crate::protocols::h2::proto::{Error, Open};
...
impl Dyn {
    ...
    pub fn convert_poll_message(
        ...
        if self.is_server() {
            crate::protocols::h2::server::Peer::convert_poll_message(pseudo, fields, stream_id)
                .map(PollMessage::Server)
        } else {
            crate::protocols::h2::client::Peer::convert_poll_message(pseudo, fields, stream_id)
