...
use crate::protocols::h2::frame::{DEFAULT_INITIAL_WINDOW_SIZE, PushPromiseHeaderError, Reason};
...
impl Recv {
    ...
    pub fn recv_push_promise(
        ...
        let (pseudo, fields) = frame.into_parts();
        let req =
            crate::protocols::h2::server::Peer::convert_poll_message(pseudo, fields, promised_id)?;
