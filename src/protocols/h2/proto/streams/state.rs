...
use crate::protocols::h2::frame::{self, Reason, StreamId};
use crate::protocols::h2::proto::{self, Error, Initiator, PollReset};
...
impl State {
    ...
    pub(super) fn ensure_reason(
        &self,
        mode: PollReset,
    ) -> Result<Option<Reason>, crate::protocols::h2::error::Error> {
        match self.inner {
