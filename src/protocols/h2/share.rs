use crate::protocols::h2::codec::UserError;
use crate::protocols::h2::frame::Reason;
use crate::protocols::h2::proto::{self, WindowSize};
...
impl<B: Buf> SendStream<B> {
    ...
    pub fn poll_capacity(
        &mut self,
        cx: &mut Context,
    ) -> Poll<Option<Result<usize, crate::protocols::h2::error::Error>>> {
        self.inner
            .poll_capacity(cx)
            .map_ok(|w| w as usize)
            .map_err(Into::into)
...
impl StreamId {
    pub(crate) fn from_internal(id: crate::protocols::h2::frame::StreamId) -> Self {
        StreamId(id.into())
    }
...
impl RecvStream {
    ...
    pub async fn data(&mut self) -> Option<Result<Bytes, crate::protocols::h2::error::Error>> {
        crate::protocols::h2::mac::poll_fn(move |cx| self.poll_data(cx)).await
    }

    /// Get optional trailers for this stream.
    pub async fn trailers(
        &mut self,
    ) -> Result<Option<HeaderMap>, crate::protocols::h2::error::Error> {
        crate::protocols::h2::mac::poll_fn(move |cx| self.poll_trailers(cx)).await
    }
    ...
    pub fn poll_data(
        &mut self,
        cx: &mut Context<'_>,
    ) -> Poll<Option<Result<Bytes, crate::protocols::h2::error::Error>>> {
    ...
    pub fn poll_trailers(
        &mut self,
        cx: &mut Context,
    ) -> Poll<Result<Option<HeaderMap>, crate::protocols::h2::error::Error>> {
...
impl futures_core::Stream for RecvStream {
    type Item = Result<Bytes, crate::protocols::h2::error::Error>;
...
impl PingPong {
    ...
    pub async fn ping(&mut self, ping: Ping) -> Result<Pong, crate::protocols::h2::error::Error> {
        self.send_ping(ping)?;
        crate::protocols::h2::mac::poll_fn(|cx| self.poll_pong(cx)).await
    }

    #[doc(hidden)]
    pub fn send_ping(&mut self, ping: Ping) -> Result<(), crate::protocols::h2::error::Error> {
    ...
    pub fn poll_pong(
        &mut self,
        cx: &mut Context,
    ) -> Poll<Result<Pong, crate::protocols::h2::error::Error>> {
